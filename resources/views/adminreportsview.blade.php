...
<div class="row">
  <form class="col-6 d-flex" action="/adminreportsview" method="POST">
        {{ csrf_field() }}
    ...
    <form class="col-6 d-flex" action="/adminreportsview1" method="POST">
        {{ csrf_field() }}
    ...
    <div class="col-lg-12 col-xl-12 col-md-12">
        ...
        <th style="background-color:#4f546c;">Permit Number</th>
            ...
            <td>{{$l->id}}</td>
                                        ...
                                        <td>
                                            <a href="{{url('arview',$l->id)}}"><i style="color:black" class="fa fa-eye"></i></a>
                                        </td>
