...
<div class="row">
<center><h3>Security Report's</h3></center>  
<div class="row">
  <form class="col-6 d-flex" action="/securityreport" method="POST">
        {{ csrf_field() }}
    ...
    <form class="col-6 d-flex" action="/securityreport1" method="POST">
        {{ csrf_field() }}
